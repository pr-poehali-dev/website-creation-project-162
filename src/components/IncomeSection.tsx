  ...
  return (
    <section className="section-padding" ref={ref}>
      <div className="container-landing reveal">
          ...
          <div className="card-dark p-4">
            <div className="bg-[#0a0a0a] rounded-lg aspect-video flex items-center justify-center border border-white/5">
              <div className="text-center p-6">
                ...
                <p className="mt-2 text-sm" style={{ color: '#a3a3a3' }}>Fanvue, апрель 2026</p>
                <p className="text-xs mt-1" style={{ color: '#a3a3a3' }}>Первые 8 дней</p>
              </div>
            </div>
          ...
          <div className="card-dark p-4">
            <div className="bg-[#0a0a0a] rounded-lg aspect-video flex items-center justify-center border border-white/5">
              <div className="text-center p-6">
                ...
                <p className="mt-2 text-sm" style={{ color: '#a3a3a3' }}>Fanvue, февраль 2026</p>
                <p className="text-xs mt-1" style={{ color: '#a3a3a3' }}>За полтора месяца</p>
              </div>
            </div>
            <p className="text-xs mt-3 text-center" style={{ color: '#a3a3a3' }}>
        ...
        <p className="text-fluid-body mb-10 max-w-2xl" style={{ color: '#e5e5e5' }}>
        ...
        <div className="space-y-4">
          {months.map((m) => (
            <div key={m.label} className="flex items-center gap-4">
              <span className="text-fluid-small w-36 shrink-0" style={{ color: '#a3a3a3' }}>{m.label}</span>
